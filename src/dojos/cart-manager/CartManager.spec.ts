...
describe('Cart Manager', () => {
    ...
    it('should get the correct first purchase discount', () => {
        // Act
        let updateResult = cartManager.updateCart(1, 1, null, 'VP19')
        let summary = cartManager.getFinalSummary()
    ...
    it('should get the wrong stacked discount first purchase + coupon', () => {
        // Act
        let updateResult = cartManager.updateCart(2, 1, 'TS_DOJO_20', 'VP19')
        let summary = cartManager.getFinalSummary()
